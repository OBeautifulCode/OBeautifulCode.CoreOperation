...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class ThrowOpExecutionFailedExceptionOp<TResult> : IModel<ThrowOpExecutionFailedExceptionOp<TResult>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionFailedExceptionOp{TResult}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ThrowOpExecutionFailedExceptionOp<TResult> left, ThrowOpExecutionFailedExceptionOp<TResult> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionFailedExceptionOp{TResult}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ThrowOpExecutionFailedExceptionOp<TResult> left, ThrowOpExecutionFailedExceptionOp<TResult> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ThrowOpExecutionFailedExceptionOp<TResult> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ThrowOpExecutionFailedExceptionOp<TResult>);
        ...
        /// <inheritdoc />
        public new ThrowOpExecutionFailedExceptionOp<TResult> DeepClone() => (ThrowOpExecutionFailedExceptionOp<TResult>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ThrowOpExecutionFailedExceptionOp{TResult}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        ...
        public ThrowOpExecutionFailedExceptionOp<TResult> DeepCloneWithDetails(string details)
        {
            var result = new ThrowOpExecutionFailedExceptionOp<TResult>(
                                 details);
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
