...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class ThrowOpExecutionDeemedNotApplicableExceptionOp : IModel<ThrowOpExecutionDeemedNotApplicableExceptionOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionDeemedNotApplicableExceptionOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ThrowOpExecutionDeemedNotApplicableExceptionOp left, ThrowOpExecutionDeemedNotApplicableExceptionOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionDeemedNotApplicableExceptionOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ThrowOpExecutionDeemedNotApplicableExceptionOp left, ThrowOpExecutionDeemedNotApplicableExceptionOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ThrowOpExecutionDeemedNotApplicableExceptionOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ThrowOpExecutionDeemedNotApplicableExceptionOp);
        ...
        /// <inheritdoc />
        public new ThrowOpExecutionDeemedNotApplicableExceptionOp DeepClone() => (ThrowOpExecutionDeemedNotApplicableExceptionOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ThrowOpExecutionDeemedNotApplicableExceptionOp" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        ...
        public ThrowOpExecutionDeemedNotApplicableExceptionOp DeepCloneWithDetails(string details)
        {
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.ThrowOpExecutionDeemedNotApplicableExceptionOp: Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
