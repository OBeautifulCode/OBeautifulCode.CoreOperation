...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class ThrowOpExecutionAbortedExceptionOp : IModel<ThrowOpExecutionAbortedExceptionOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionAbortedExceptionOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ThrowOpExecutionAbortedExceptionOp left, ThrowOpExecutionAbortedExceptionOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ThrowOpExecutionAbortedExceptionOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ThrowOpExecutionAbortedExceptionOp left, ThrowOpExecutionAbortedExceptionOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ThrowOpExecutionAbortedExceptionOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ThrowOpExecutionAbortedExceptionOp);
        ...
        /// <inheritdoc />
        public new ThrowOpExecutionAbortedExceptionOp DeepClone() => (ThrowOpExecutionAbortedExceptionOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ThrowOpExecutionAbortedExceptionOp" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        ...
        public ThrowOpExecutionAbortedExceptionOp DeepCloneWithDetails(string details)
        {
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.ThrowOpExecutionAbortedExceptionOp: Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
