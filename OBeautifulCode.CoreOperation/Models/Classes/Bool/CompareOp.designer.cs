...
namespace OBeautifulCode.CoreOperation
{
    ...
    public partial class CompareOp : IModel<CompareOp>
    {
        ...
        /// <inheritdoc />
        public new CompareOp DeepClone() => (CompareOp)this.DeepCloneInternal();
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.CompareOp: Left = {this.Left?.ToString() ?? "<null>"}, Operator = {this.Operator?.ToString() ?? "<null>"}, Right = {this.Right?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Left, options, propertyPathTracker, nameof(this.Left));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Right, options, propertyPathTracker, nameof(this.Right));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
