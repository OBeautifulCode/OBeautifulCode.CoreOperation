...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class GetConstValueOp<TValue> : IModel<GetConstValueOp<TValue>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="GetConstValueOp{TValue}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(GetConstValueOp<TValue> left, GetConstValueOp<TValue> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="GetConstValueOp{TValue}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(GetConstValueOp<TValue> left, GetConstValueOp<TValue> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(GetConstValueOp<TValue> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as GetConstValueOp<TValue>);
        ...
        /// <inheritdoc />
        public new GetConstValueOp<TValue> DeepClone() => (GetConstValueOp<TValue>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="GetConstValueOp{TValue}" /> using the specified <paramref name="value" /> for <see cref="Value" /> and a deep clone of every other property.</returns>
        ...
        public GetConstValueOp<TValue> DeepCloneWithValue(TValue value)
        {
        ...
        protected override OperationBase DeepCloneInternal()
        {
            var result = new GetConstValueOp<TValue>
                             {
                                 Value = this.Value == null ? default : this.Value.DeepClone(),
                             };
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Value = {this.Value?.ToString() ?? "<null>"}.");
