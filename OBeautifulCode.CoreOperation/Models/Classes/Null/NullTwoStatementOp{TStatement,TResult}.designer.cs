...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class NullTwoStatementOp<TStatement, TResult> : IModel<NullTwoStatementOp<TStatement, TResult>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="NullTwoStatementOp{TStatement, TResult}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(NullTwoStatementOp<TStatement, TResult> left, NullTwoStatementOp<TStatement, TResult> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="NullTwoStatementOp{TStatement, TResult}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(NullTwoStatementOp<TStatement, TResult> left, NullTwoStatementOp<TStatement, TResult> right) => !(left == right);
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as NullTwoStatementOp<TStatement, TResult>);
        ...
        /// <inheritdoc />
        public new NullTwoStatementOp<TStatement, TResult> DeepClone() => (NullTwoStatementOp<TStatement, TResult>)this.DeepCloneInternal();
        ...
        public override TwoStatementOpBase<TStatement, TResult> DeepCloneWithStatement1(IReturningOperation<TStatement> statement1)
        {
            var result = new NullTwoStatementOp<TStatement, TResult>
                             {
                                 Statement1 = statement1,
                                 Statement2 = this.Statement2?.DeepClone(),
                             };
        ...
        public override TwoStatementOpBase<TStatement, TResult> DeepCloneWithStatement2(IReturningOperation<TStatement> statement2)
        {
            var result = new NullTwoStatementOp<TStatement, TResult>
                             {
                                 Statement1 = this.Statement1?.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Statement1 = {this.Statement1?.ToString() ?? "<null>"}, Statement2 = {this.Statement2?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Statement1, options, propertyPathTracker, nameof(this.Statement1));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Statement2, options, propertyPathTracker, nameof(this.Statement2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
