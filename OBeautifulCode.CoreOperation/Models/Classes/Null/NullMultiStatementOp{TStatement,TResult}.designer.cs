...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class NullMultiStatementOp<TStatement, TResult> : IModel<NullMultiStatementOp<TStatement, TResult>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="NullMultiStatementOp{TStatement, TResult}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(NullMultiStatementOp<TStatement, TResult> left, NullMultiStatementOp<TStatement, TResult> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="NullMultiStatementOp{TStatement, TResult}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(NullMultiStatementOp<TStatement, TResult> left, NullMultiStatementOp<TStatement, TResult> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(NullMultiStatementOp<TStatement, TResult> other)
        {
            ...
            var result = this.Statements.IsEqualTo(other.Statements);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as NullMultiStatementOp<TStatement, TResult>);
        ...
        /// <inheritdoc />
        public new NullMultiStatementOp<TStatement, TResult> DeepClone() => (NullMultiStatementOp<TStatement, TResult>)this.DeepCloneInternal();
        ...
        public override MultiStatementOpBase<TStatement, TResult> DeepCloneWithStatements(IReadOnlyCollection<IReturningOperation<TStatement>> statements)
        {
            var result = new NullMultiStatementOp<TStatement, TResult>
                             {
        ...
        protected override OperationBase DeepCloneInternal()
        {
            var result = new NullMultiStatementOp<TStatement, TResult>
                             {
                                 Statements = this.Statements?.DeepClone(),
                             };
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Statements = {this.Statements?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Statements, options, propertyPathTracker, nameof(this.Statements));
