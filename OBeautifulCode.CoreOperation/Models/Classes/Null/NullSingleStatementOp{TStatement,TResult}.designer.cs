...
namespace OBeautifulCode.CoreOperation
{
    ...
    [Serializable]
    public partial class NullSingleStatementOp<TStatement, TResult> : IModel<NullSingleStatementOp<TStatement, TResult>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="NullSingleStatementOp{TStatement, TResult}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(NullSingleStatementOp<TStatement, TResult> left, NullSingleStatementOp<TStatement, TResult> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="NullSingleStatementOp{TStatement, TResult}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(NullSingleStatementOp<TStatement, TResult> left, NullSingleStatementOp<TStatement, TResult> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(NullSingleStatementOp<TStatement, TResult> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as NullSingleStatementOp<TStatement, TResult>);
        ...
        /// <inheritdoc />
        public new NullSingleStatementOp<TStatement, TResult> DeepClone() => (NullSingleStatementOp<TStatement, TResult>)this.DeepCloneInternal();
        ...
        public override SingleStatementOpBase<TStatement, TResult> DeepCloneWithStatement(IReturningOperation<TStatement> statement)
        {
            var result = new NullSingleStatementOp<TStatement, TResult>
                             {
                                 Statement = statement,
                             };
        ...
        protected override OperationBase DeepCloneInternal()
        {
            var result = new NullSingleStatementOp<TStatement, TResult>
                             {
                                 Statement = this.Statement?.DeepClone(),
                             };
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Statement = {this.Statement?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Statement, options, propertyPathTracker, nameof(this.Statement));
