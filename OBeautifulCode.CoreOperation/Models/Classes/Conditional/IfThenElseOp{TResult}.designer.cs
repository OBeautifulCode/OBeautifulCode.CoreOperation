...
namespace OBeautifulCode.CoreOperation
{
    ...
    public partial class IfThenElseOp<TResult> : IModel<IfThenElseOp<TResult>>
    {
            ...
            var result = new IfThenElseOp<TResult>
                             {
                                 ...
                                 ElseStatement = this.ElseStatement?.DeepClone(),
                             };
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.{this.GetType().ToStringReadable()}: Condition = {this.Condition?.ToString() ?? "<null>"}, Statement = {this.Statement?.ToString() ?? "<null>"}, ElseStatement = {this.ElseStatement?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Condition, options, propertyPathTracker, nameof(this.Condition));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ElseStatement, options, propertyPathTracker, nameof(this.ElseStatement));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
