    ...
    public partial class DivideOp : IModel<DivideOp>
    {
        ...
        public DivideOp DeepCloneWithNumerator(IReturningOperation<decimal> numerator)
        {
            var result = new DivideOp
                             {
                                 Numerator   = numerator,
                                 Denominator = this.Denominator?.DeepClone(),
                             };
        ...
        public DivideOp DeepCloneWithDenominator(IReturningOperation<decimal> denominator)
        {
            var result = new DivideOp
                             {
                                 Numerator   = this.Numerator?.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.CoreOperation.DivideOp: Numerator = {this.Numerator?.ToString() ?? "<null>"}, Denominator = {this.Denominator?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Numerator, options, propertyPathTracker, nameof(this.Numerator));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Denominator, options, propertyPathTracker, nameof(this.Denominator));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
