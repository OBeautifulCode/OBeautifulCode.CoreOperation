...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly TwoStatementOpBase<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<TwoStatementOpBase<Version, Version>>();

        private static readonly EquatableTestScenarios<TwoStatementOpBase<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<TwoStatementOpBase<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<TwoStatementOpBase<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TwoStatementOpBase<Version, Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TwoStatementOpBase<Version, Version>[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithStatement1(A.Dummy<TwoStatementOpBase<Version, Version>>().Whose(_ => !_.Statement1.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statement1)).Statement1),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithStatement2(A.Dummy<TwoStatementOpBase<Version, Version>>().Whose(_ => !_.Statement2.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statement2)).Statement2),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void TwoStatementOpBase_of_Version_Version___Should_implement_IModel_of_TwoStatementOpBase_of_Version_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(TwoStatementOpBase<Version, Version>);

                var expectedModelMethods = typeof(IModel<TwoStatementOpBase<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TwoStatementOpBase<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TwoStatementOpBase_of_Version_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TwoStatementOpBase<Version, Version>);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<TwoStatementOpBase<Version, Version>>();

                // Act
                var actual = (TwoStatementOpBase<Version, Version>)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TwoStatementOpBase<Version, Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TwoStatementOpBase<Version, Version> systemUnderTest1 = null;
                TwoStatementOpBase<Version, Version> systemUnderTest2 = null;
