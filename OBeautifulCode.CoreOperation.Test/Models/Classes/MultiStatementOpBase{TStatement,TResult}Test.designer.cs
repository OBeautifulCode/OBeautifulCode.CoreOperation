...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly MultiStatementOpBase<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<MultiStatementOpBase<Version, Version>>();

        private static readonly EquatableTestScenarios<MultiStatementOpBase<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<MultiStatementOpBase<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<MultiStatementOpBase<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MultiStatementOpBase<Version, Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MultiStatementOpBase<Version, Version>[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithStatements(A.Dummy<MultiStatementOpBase<Version, Version>>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void MultiStatementOpBase_of_Version_Version___Should_implement_IModel_of_MultiStatementOpBase_of_Version_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(MultiStatementOpBase<Version, Version>);

                var expectedModelMethods = typeof(IModel<MultiStatementOpBase<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MultiStatementOpBase<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MultiStatementOpBase_of_Version_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MultiStatementOpBase<Version, Version>);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<MultiStatementOpBase<Version, Version>>();

                // Act
                var actual = (MultiStatementOpBase<Version, Version>)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MultiStatementOpBase<Version, Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                MultiStatementOpBase<Version, Version> systemUnderTest1 = null;
                MultiStatementOpBase<Version, Version> systemUnderTest2 = null;
