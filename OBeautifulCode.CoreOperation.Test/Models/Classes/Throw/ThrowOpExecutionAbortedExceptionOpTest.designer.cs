...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    public static partial class ThrowOpExecutionAbortedExceptionOpTest
    {
                ...
                new StringRepresentationTestScenario<ThrowOpExecutionAbortedExceptionOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ThrowOpExecutionAbortedExceptionOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.ThrowOpExecutionAbortedExceptionOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<ThrowOpExecutionAbortedExceptionOp> ValidModelTestScenarios = new ValidModelTestScenarios<ThrowOpExecutionAbortedExceptionOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ThrowOpExecutionAbortedExceptionOp>
                {
                    Name = "a dummy ThrowOpExecutionAbortedExceptionOp should be valid",
                    SystemUnderTest = A.Dummy<ThrowOpExecutionAbortedExceptionOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ThrowOpExecutionAbortedExceptionOp___Should_implement_IModel_of_ThrowOpExecutionAbortedExceptionOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ThrowOpExecutionAbortedExceptionOp);

                var expectedModelMethods = typeof(IModel<ThrowOpExecutionAbortedExceptionOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ThrowOpExecutionAbortedExceptionOp>));
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ThrowOpExecutionAbortedExceptionOp>();
