...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ThrowOpExecutionFailedExceptionOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ThrowOpExecutionFailedExceptionOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ThrowOpExecutionFailedExceptionOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.ThrowOpExecutionFailedExceptionOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ThrowOpExecutionFailedExceptionOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ThrowOpExecutionFailedExceptionOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ThrowOpExecutionFailedExceptionOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    Name = "Details should return same 'details' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ThrowOpExecutionFailedExceptionOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<ThrowOpExecutionFailedExceptionOp>
                        {
                            SystemUnderTest = new ThrowOpExecutionFailedExceptionOp(
        ...
        private static readonly DeepCloneWithTestScenarios<ThrowOpExecutionFailedExceptionOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ThrowOpExecutionFailedExceptionOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<ThrowOpExecutionFailedExceptionOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ThrowOpExecutionFailedExceptionOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ThrowOpExecutionFailedExceptionOp>();

        private static readonly EquatableTestScenarios<ThrowOpExecutionFailedExceptionOp> EquatableTestScenarios = new EquatableTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ThrowOpExecutionFailedExceptionOp[]
                    {
                        new ThrowOpExecutionFailedExceptionOp(
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ThrowOpExecutionFailedExceptionOp[]
                    {
                        new ThrowOpExecutionFailedExceptionOp(
                                A.Dummy<ThrowOpExecutionFailedExceptionOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<ThrowOpExecutionFailedExceptionOp> ValidModelTestScenarios = new ValidModelTestScenarios<ThrowOpExecutionFailedExceptionOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ThrowOpExecutionFailedExceptionOp>
                {
                    Name = "a dummy ThrowOpExecutionFailedExceptionOp should be valid",
                    SystemUnderTest = A.Dummy<ThrowOpExecutionFailedExceptionOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ThrowOpExecutionFailedExceptionOp___Should_implement_IModel_of_ThrowOpExecutionFailedExceptionOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ThrowOpExecutionFailedExceptionOp);

                var expectedModelMethods = typeof(IModel<ThrowOpExecutionFailedExceptionOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ThrowOpExecutionFailedExceptionOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ThrowOpExecutionFailedExceptionOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ThrowOpExecutionFailedExceptionOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ThrowOpExecutionFailedExceptionOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ThrowOpExecutionFailedExceptionOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ThrowOpExecutionFailedExceptionOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ThrowOpExecutionFailedExceptionOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ThrowOpExecutionFailedExceptionOp systemUnderTest1 = null;
                ThrowOpExecutionFailedExceptionOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ThrowOpExecutionFailedExceptionOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowOpExecutionFailedExceptionOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowOpExecutionFailedExceptionOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowOpExecutionFailedExceptionOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowOpExecutionFailedExceptionOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowOpExecutionFailedExceptionOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
