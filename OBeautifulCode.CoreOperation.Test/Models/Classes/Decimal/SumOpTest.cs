// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SumOpTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    public static partial class SumOpTest
    {
        [SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode", Justification = ObcSuppressBecause.CA1505_AvoidUnmaintainableCode_DisagreeWithAssessment)]
        ...
        static SumOpTest()
        {
            SelfValidationTestScenarios
                .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<SumOp>();

                    systemUnderTest.Statements = systemUnderTest.Statements.Take(1).ToList();

                    var result = new SelfValidationTestScenario<SumOp>
                    {
