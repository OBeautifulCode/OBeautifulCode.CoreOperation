// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiplyOpTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    public static partial class MultiplyOpTest
    {
        [SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode", Justification = ObcSuppressBecause.CA1505_AvoidUnmaintainableCode_DisagreeWithAssessment)]
        [SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline", Justification = ObcSuppressBecause.CA1810_InitializeReferenceTypeStaticFieldsInline_FieldsDeclaredInCodeGeneratedPartialTestClass)]
        static MultiplyOpTest()
        {
            SelfValidationTestScenarios
                .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<MultiplyOp>();

                    systemUnderTest.Statements = systemUnderTest.Statements.Take(1).ToList();

                    var result = new SelfValidationTestScenario<MultiplyOp>
                    {
