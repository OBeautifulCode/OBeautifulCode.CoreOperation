...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    public static partial class DivideOpTest
    {
                ...
                new StringRepresentationTestScenario<DivideOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<DivideOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.DivideOp: Numerator = {systemUnderTest.Numerator?.ToString() ?? "<null>"}, Denominator = {systemUnderTest.Denominator?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new EquatableTestScenario<DivideOp>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DivideOp[]
                    {
                        new DivideOp
                            {
                                Numerator   = ReferenceObjectForEquatableTestScenarios.Numerator,
                                Denominator = ReferenceObjectForEquatableTestScenarios.Denominator,
                            },
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DivideOp[]
                    {
                        new DivideOp
                            {
                                Numerator   = A.Dummy<DivideOp>().Whose(_ => !_.Numerator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Numerator)).Numerator,
                                Denominator = ReferenceObjectForEquatableTestScenarios.Denominator,
                            },
                        new DivideOp
                            {
                                Numerator   = ReferenceObjectForEquatableTestScenarios.Numerator,
                                Denominator = A.Dummy<DivideOp>().Whose(_ => !_.Denominator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Denominator)).Denominator,
                            },
                    },
        ...
        private static readonly ValidModelTestScenarios<DivideOp> ValidModelTestScenarios = new ValidModelTestScenarios<DivideOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<DivideOp>
                {
                    Name = "a dummy DivideOp should be valid",
                    SystemUnderTest = A.Dummy<DivideOp>(),
                });

        private static readonly SelfValidationTestScenarios<DivideOp> SelfValidationTestScenarios = new SelfValidationTestScenarios<DivideOp>()
            .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<DivideOp>();

                    systemUnderTest.Numerator = null;

                    var result = new SelfValidationTestScenario<DivideOp>
                    {
                        Name = "GetSelfValidationFailures() should return a failure when property 'Numerator' is null scenario",
                        SystemUnderTest = systemUnderTest,
                        ExpectedFailurePropertyNames = new[] { "Numerator" },
                        ExpectedFailureMessageContains = new[] { "Numerator", "null", },
            ...
            .AddScenario(() =>
                {
                    ...
                    systemUnderTest.Denominator = null;

                    var result = new SelfValidationTestScenario<DivideOp>
                    {
                        Name = "GetSelfValidationFailures() should return a failure when property 'Denominator' is null scenario",
                        SystemUnderTest = systemUnderTest,
                        ExpectedFailurePropertyNames = new[] { "Denominator" },
                        ExpectedFailureMessageContains = new[] { "Denominator", "null", },
                        ScenarioPassesWhen = SelfValidationTestScenarioPassesWhen.OnlyOneFailureMeetsExpectation,
                    };
