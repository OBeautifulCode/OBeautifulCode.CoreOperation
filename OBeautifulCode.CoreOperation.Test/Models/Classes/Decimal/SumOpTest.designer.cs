...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SumOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SumOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SumOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<SumOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.SumOp: Statements = {systemUnderTest.Statements?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<SumOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SumOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SumOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SumOp>().ThatIs(_ => !systemUnderTest.Statements.IsEqualTo(_.Statements));

                        var result = new SystemUnderTestDeepCloneWithValue<SumOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly SumOp ReferenceObjectForEquatableTestScenarios = A.Dummy<SumOp>();

        private static readonly EquatableTestScenarios<SumOp> EquatableTestScenarios = new EquatableTestScenarios<SumOp>()
            .AddScenario(() =>
                new EquatableTestScenario<SumOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SumOp[]
                    {
                        new SumOp
                            {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new SumOp[]
                    {
                        new SumOp
                            {
                                Statements = A.Dummy<SumOp>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements,
                            },
                    },
        ...
        private static readonly ValidModelTestScenarios<SumOp> ValidModelTestScenarios = new ValidModelTestScenarios<SumOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<SumOp>
                {
                    Name = "a dummy SumOp should be valid",
                    SystemUnderTest = A.Dummy<SumOp>(),
                });

        private static readonly SelfValidationTestScenarios<SumOp> SelfValidationTestScenarios = new SelfValidationTestScenarios<SumOp>()
            .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<SumOp>();
        ...
        public static class StructuralTesting
        {
            ...
            public static void SumOp___Should_implement_IModel_of_SumOp___When_reflecting()
            {
                // Arrange
                var type = typeof(SumOp);

                var expectedModelMethods = typeof(IModel<SumOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SumOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SumOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SumOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SumOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SumOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SumOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SumOp systemUnderTest1 = null;
                SumOp systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SumOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SumOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SumOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SumOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SumOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
