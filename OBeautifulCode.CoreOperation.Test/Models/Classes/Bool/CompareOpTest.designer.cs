...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompareOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompareOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompareOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompareOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompareOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.CompareOp: Left = {systemUnderTest.Left?.ToString() ?? "<null>"}, Operator = {systemUnderTest.Operator?.ToString() ?? "<null>"}, Right = {systemUnderTest.Right?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<CompareOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompareOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompareOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompareOp>().ThatIs(_ => !systemUnderTest.Left.IsEqualTo(_.Left));

                        var result = new SystemUnderTestDeepCloneWithValue<CompareOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompareOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompareOp>().ThatIs(_ => !systemUnderTest.Operator.IsEqualTo(_.Operator));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompareOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompareOp>().ThatIs(_ => !systemUnderTest.Right.IsEqualTo(_.Right));
        ...
        private static readonly CompareOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CompareOp>();

        private static readonly EquatableTestScenarios<CompareOp> EquatableTestScenarios = new EquatableTestScenarios<CompareOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CompareOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompareOp[]
                    {
                        new CompareOp
                            {
                                Left     = ReferenceObjectForEquatableTestScenarios.Left,
                                Operator = ReferenceObjectForEquatableTestScenarios.Operator,
                                Right    = ReferenceObjectForEquatableTestScenarios.Right,
                            },
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CompareOp[]
                    {
                        new CompareOp
                            {
                                Left     = A.Dummy<CompareOp>().Whose(_ => !_.Left.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Left)).Left,
                                Operator = ReferenceObjectForEquatableTestScenarios.Operator,
                                Right    = ReferenceObjectForEquatableTestScenarios.Right,
                            },
                        new CompareOp
                            {
                                Left     = ReferenceObjectForEquatableTestScenarios.Left,
                                Operator = A.Dummy<CompareOp>().Whose(_ => !_.Operator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Operator)).Operator,
                                Right    = ReferenceObjectForEquatableTestScenarios.Right,
                            },
                        new CompareOp
                            {
                                Left     = ReferenceObjectForEquatableTestScenarios.Left,
                                Operator = ReferenceObjectForEquatableTestScenarios.Operator,
                                Right    = A.Dummy<CompareOp>().Whose(_ => !_.Right.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Right)).Right,
                            },
                    },
        ...
        private static readonly ValidModelTestScenarios<CompareOp> ValidModelTestScenarios = new ValidModelTestScenarios<CompareOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CompareOp>
                {
                    Name = "a dummy CompareOp should be valid",
                    SystemUnderTest = A.Dummy<CompareOp>(),
                });

        private static readonly SelfValidationTestScenarios<CompareOp> SelfValidationTestScenarios = new SelfValidationTestScenarios<CompareOp>()
            .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<CompareOp>();

                    systemUnderTest.Left = null;

                    var result = new SelfValidationTestScenario<CompareOp>
                    {
                        Name = "GetSelfValidationFailures() should return a failure when property 'Left' is null scenario",
                        SystemUnderTest = systemUnderTest,
                        ExpectedFailurePropertyNames = new[] { "Left" },
                        ExpectedFailureMessageContains = new[] { "Left", "null", },
            ...
            .AddScenario(() =>
                {
                    ...
                    systemUnderTest.Operator = null;

                    var result = new SelfValidationTestScenario<CompareOp>
                    {
                        Name = "GetSelfValidationFailures() should return a failure when property 'Operator' is null scenario",
                        SystemUnderTest = systemUnderTest,
                        ExpectedFailurePropertyNames = new[] { "Operator" },
                        ExpectedFailureMessageContains = new[] { "Operator", "null", },
                        ScenarioPassesWhen = SelfValidationTestScenarioPassesWhen.OnlyOneFailureMeetsExpectation,
                    };
            ...
            .AddScenario(() =>
                {
                    ...
                    systemUnderTest.Right = null;

                    var result = new SelfValidationTestScenario<CompareOp>
                    {
                        Name = "GetSelfValidationFailures() should return a failure when property 'Right' is null scenario",
                        SystemUnderTest = systemUnderTest,
                        ExpectedFailurePropertyNames = new[] { "Right" },
                        ExpectedFailureMessageContains = new[] { "Right", "null", },
                        ScenarioPassesWhen = SelfValidationTestScenarioPassesWhen.OnlyOneFailureMeetsExpectation,
                    };
        ...
        public static class StructuralTesting
        {
            ...
            public static void CompareOp___Should_implement_IModel_of_CompareOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CompareOp);

                var expectedModelMethods = typeof(IModel<CompareOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompareOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompareOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompareOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompareOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Left == null)
                {
                    actual.Left.AsTest().Must().BeNull();
                }
                else if (!actual.Left.GetType().IsValueType)
                {
                ...
                if (systemUnderTest.Operator == null)
                {
                    actual.Operator.AsTest().Must().BeNull();
                }
                else if (!actual.Operator.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Operator.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Operator);
                }

                if (systemUnderTest.Right == null)
                {
                    actual.Right.AsTest().Must().BeNull();
                }
                else if (!actual.Right.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            {
                var propertyNames = new string[] { "Left", "Operator", "Right" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompareOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompareOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompareOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CompareOp systemUnderTest1 = null;
                CompareOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompareOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompareOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompareOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompareOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompareOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompareOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
