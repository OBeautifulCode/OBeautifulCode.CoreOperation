...
namespace OBeautifulCode.CoreOperation.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AndAlsoOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AndAlsoOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<AndAlsoOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.CoreOperation.AndAlsoOp: Statements = {systemUnderTest.Statements?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<AndAlsoOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AndAlsoOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AndAlsoOp>().ThatIs(_ => !systemUnderTest.Statements.IsEqualTo(_.Statements));

                        var result = new SystemUnderTestDeepCloneWithValue<AndAlsoOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly AndAlsoOp ReferenceObjectForEquatableTestScenarios = A.Dummy<AndAlsoOp>();

        private static readonly EquatableTestScenarios<AndAlsoOp> EquatableTestScenarios = new EquatableTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new EquatableTestScenario<AndAlsoOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AndAlsoOp[]
                    {
                        new AndAlsoOp
                            {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new AndAlsoOp[]
                    {
                        new AndAlsoOp
                            {
                                Statements = A.Dummy<AndAlsoOp>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements,
                            },
                    },
        ...
        private static readonly ValidModelTestScenarios<AndAlsoOp> ValidModelTestScenarios = new ValidModelTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<AndAlsoOp>
                {
                    Name = "a dummy AndAlsoOp should be valid",
                    SystemUnderTest = A.Dummy<AndAlsoOp>(),
                });

        private static readonly SelfValidationTestScenarios<AndAlsoOp> SelfValidationTestScenarios = new SelfValidationTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                {
                    var systemUnderTest = A.Dummy<AndAlsoOp>();
        ...
        public static class StructuralTesting
        {
            ...
            public static void AndAlsoOp___Should_implement_IModel_of_AndAlsoOp___When_reflecting()
            {
                // Arrange
                var type = typeof(AndAlsoOp);

                var expectedModelMethods = typeof(IModel<AndAlsoOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AndAlsoOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AndAlsoOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AndAlsoOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AndAlsoOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AndAlsoOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AndAlsoOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AndAlsoOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                AndAlsoOp systemUnderTest1 = null;
                AndAlsoOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AndAlsoOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AndAlsoOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AndAlsoOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AndAlsoOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AndAlsoOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AndAlsoOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
